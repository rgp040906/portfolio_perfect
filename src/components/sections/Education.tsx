      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-mono font-extrabold text-white tracking-tight">
            EDUCATION<span className="text-[#39FF88]">.</span>
          </h2>
        ...
        <div className="max-w-4xl">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="rounded-xl border border-white/[0.09] bg-[#0d131d]/80 p-8 relative overflow-hidden card-hover-lift"
          >
            <div className="absolute top-4 right-4 p-4 opacity-5 text-[#39FF88]">
              <GraduationCap size={140} />
            </div>

            <div className="relative z-10">
              <span className="inline-block px-3 py-1 bg-[#39FF88]/10 text-[#39FF88] border border-[#39FF88]/30 rounded-full text-xs font-mono font-bold mb-4">
              ...
              <h4 className="text-lg font-mono font-semibold text-[#39FF88] mb-4">
              ...
              <div className="pt-6 border-t border-white/[0.08]">
                <div className="flex items-center gap-2 mb-4 text-white font-mono text-xs font-bold uppercase tracking-wider">
                  <BookOpen size={16} className="text-[#39FF88]" />
                ...
                <div className="flex flex-wrap gap-2.5">
                  {[
                    ...
                    <span
                      key={course}
                      className="px-3 py-1 bg-black/40 border border-white/[0.08] rounded text-xs font-mono text-gray-300"
                    >
                      {course}
                    </span>
                  ))}
