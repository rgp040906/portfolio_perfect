...
export default function About() {
  return (
    <section id="about" className="py-20 relative z-10 bg-[#050706]">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-mono font-extrabold text-white tracking-tight">
            ABOUT ME<span className="text-[#39ff6a]">.</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-7">
            <motion.div
              ...
              className="rounded-xl border border-white/[0.08] bg-[#080b09]/85 backdrop-blur-md p-6 md:p-8 font-mono text-sm leading-relaxed"
            >
              {/* Code Editor Header */}
              <div className="flex items-center justify-between pb-4 mb-6 border-b border-white/[0.08]">
                <div className="flex items-center gap-2">
                  ...
                  <div className="w-3 h-3 rounded-full bg-[#39ff6a]/80"></div>
                </div>
              ...
              <div className="space-y-3">
                <p>
                  <span className="text-[#39ff6a]">const</span>{" "}
                  <span className="text-emerald-300">securityEngineer</span> = {"{"}
                </p>
                
                <div className="pl-6 space-y-2 border-l-2 border-[#39ff6a]/20">
                  <p>
          ...
          <div className="lg:col-span-5">
            <motion.div
              ...
              className="rounded-xl border border-white/[0.08] bg-[#080b09]/90 p-6 md:p-8 flex flex-col justify-between relative overflow-hidden group hover:border-[#39ff6a]/40 transition-colors"
            >
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-2">
                  <Cpu className="text-[#39ff6a]" size={20} />
                  <span className="font-mono text-xs font-bold text-white uppercase tracking-wider">SYSTEM_HEALTH</span>
                </div>
                <span className="px-2.5 py-1 rounded-full bg-[#39ff6a]/10 text-[#39ff6a] border border-[#39ff6a]/30 font-mono text-[10px] font-bold">
                  OPTIMAL
                </span>
              </div>
              ...
              <div className="space-y-4 font-mono text-xs my-4">
                <div className="p-3 rounded-lg bg-black/50 border border-white/5 flex items-center justify-between">
                  ...
                  <span className="text-[#39ff6a] font-bold">PASSED (0 Critical)</span>
                </div>
                <div className="p-3 rounded-lg bg-black/50 border border-white/5 flex items-center justify-between">
                ...
                <div className="p-3 rounded-lg bg-black/50 border border-white/5 flex items-center justify-between">
                  ...
                  <span className="text-[#39ff6a] font-bold">ACTIVE // 100% UP</span>
                </div>
              </div>
              ...
              <div className="mt-4 pt-4 border-t border-white/[0.08] flex items-center justify-between text-xs font-mono text-gray-400">
                <span className="flex items-center gap-1.5">
                  <CheckCircle2 size={14} className="text-[#39ff6a]" />
