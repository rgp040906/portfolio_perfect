...
export default function SecurityLab() {
  ...
  return (
    <section id="security-lab" className="py-20 relative z-10 bg-[#050706]">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-mono font-extrabold text-white tracking-tight">
            SECURITY LAB<span className="text-[#39ff6a]">.</span>
          </h2>
          ...
          {securityLab.map((lab, i) => {
            ...
            return (
              <motion.div
                ...
                className="rounded-xl border border-white/[0.08] bg-[#080b09]/85 overflow-hidden"
              >
                <button
                ...
                >
                  <div className="flex items-center gap-4">
                    <Terminal className={isOpen ? "text-[#39ff6a]" : "text-gray-500"} size={20} />
                  ...
                  <ChevronDown
                    className={`transition-transform duration-300 ${
                      isOpen ? "rotate-180 text-[#39ff6a]" : "text-gray-500"
                    }`}
                    size={20}
                  />
                </button>
                      ...
                      <div className="p-6 md:p-8 font-mono text-sm space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div className="p-4 rounded-lg bg-white/[0.02] border border-white/5">
                            <h4 className="text-[#39ff6a] font-bold mb-2 flex items-center gap-2">
                              <span>&gt; OBJECTIVE</span>
                            </h4>
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-2">
                            {lab.tools.map((tool) => (
                              <span
                                key={tool}
                                className="px-3 py-1 bg-[#39ff6a]/10 text-[#39ff6a] border border-[#39ff6a]/30 rounded text-xs font-bold"
                              >
                                {tool}
                              </span>
                            ))}
                        ...
                        <div className="space-y-4 pt-2">
                          <div className="pl-4 border-l-2 border-[#39ff6a]/40">
                          ...
                          <div className="p-4 rounded-lg bg-[#39ff6a]/5 border border-[#39ff6a]/20 mt-4">
                            <h4 className="text-[#39ff6a] font-bold mb-1 flex items-center gap-2">
                              <CheckCircle size={16} />
